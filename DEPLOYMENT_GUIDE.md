...
Complete step-by-step guide for setting up a ** 3 AWS EC2 instances** to host Dev, Test, and Production environments efficiently.
...
You will create **3 EC2 instance** to host all three environments.
...
9. Launch two additional instances with the same instructions, but update the **network settings** 
